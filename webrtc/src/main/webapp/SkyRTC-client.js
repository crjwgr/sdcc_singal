var SkyRTC = function() {
    ...
    skyrtc.prototype.createStream = function(options) {
        ...
        if (getUserMedia) {
            ...
            getUserMedia.call(navigator, options, function(stream) {
                    ...
                    alert(that.initializedStreams +"" +that.numStreams)
    ...
    skyrtc.prototype.sendAnswer = function(socketId, sdp) {
        ...
        alert("peerConnections:"+JSON.stringify(this.peerConnections)+"  socketID:"+socketId)
        var that = this;
        alert("pc:"+pc)
    ...
    skyrtc.prototype.createPeerConnection = function(socketId) {
        ...
        alert("创建PeerConnection："+socketId+"  "+pc);
    ...
    skyrtc.prototype.addDataChannels = function() {
        var connection;
        alert("peerConnections:"+JSON.stringify(this.peerConnections))
        for (connection in this.peerConnections) {
